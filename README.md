...
<div align="center">
  ...
  <p align="center">
    A customizable local-first dashboard and launcher for your workflows.
  </p>
</div>
...
* Multi-page layout with tabbed views  
* Local-first storage with optional export/import  
* Live widgets: weather, RSS, uptime, COVID, iframe  
* Extension-based native launching for Windows apps  
* Themes, font library, glow visual effects  
* Drag-and-drop group and tile arrangement  
...
* Favicon and logo fallbacks (Google and Clearbit)  
...
<a href="https://www.tiktok.com/@benjaminspowell">
  <img
    ...
    alt="TikTok - By Benjamin S Powell - Idea from LabDash"
  />
</a>
